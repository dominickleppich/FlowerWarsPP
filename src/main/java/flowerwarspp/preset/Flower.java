 ...
 *
 * <p>
 * Diese Klasse repraesentiert eine Blume. Eine Blume wird immer durch die drei umliegenden {@link Position}en definiert.
 * </p>
 * <h2>Wichtige Hinweise</h2>
 * <p>
 * Eine Blume kann nach der Erzeugung nicht mehr veraendert werden. Die Reihenfolge, in der die drei Positionen beim Erzeugen an den Konstruktor
 * uebergeben werden hat keine Auswirkung darauf, welche der drei Positionen bei einem Aufruf von {@link #getFirst()}, {@link #getSecond()}
 * bzw. {@link #getThird()} zurueckgeliefert wird. Intern werden die Positionen umsortiert, damit zwei Blumen mit identischen
 * Positionen, die jedoch mit vertauschter Reihenfolge der Positionen erzeugt wurden, dennoch einfach vergleichbar sind.
 * </p>
 * <h2>Zusatzfunktionalitaet</h2>
 * <p>
 * Die Methode {@link #parseFlower(String)} kann einen {@link String} in ein Flower-Objekt umwandeln, wenn das Format gueltig ist.
 * </p>
 * <p>
 * Die Funktion {@link #hashCode()} liefert fuer alle gueltigen Blumen einen eindeutigen Hash-Wert zurueck. Spezielle Datenstrukturen
 * wie zum Beispiel ein {@link HashSet} koennen sich das zu Nutze machen. Eine Blume ist weiterhin mit anderen Blumen
...
public class Flower implements Serializable, Comparable<Flower> {
    ...
    /**
     * Erzeuge eine neue Blume unter Angabe der drei umliegenden Positionen. Beim Erzeugen werden die Positionen automatisch umsortiert.
     *
     * @param first  erste Position
     * @param second zweite Position
     * @param third  dritte Position
     * @throws IllegalArgumentException falls eine der Positionen {@code null} ist
     */
     ...
     *
     * @param first erste Position
     * @throws IllegalArgumentException falls die Position {@code null} ist
     */
    ...
    /**
     * Wandle einen uebergebenen {@link String} in eine Blume um. Das Format ist: {@code {(Pos1.column,Pos1.row),(Pos2.column,Pos2.row),(Pos3.column,Pos3.row)}}
     *
     * @param string umzuwandelnder String
     * @return eine Blume als {@link Flower}-Objekt
     * @throws FlowerFormatException falls kein gueltiger String uebergeben wird oder das Format ungueltig ist
     */
