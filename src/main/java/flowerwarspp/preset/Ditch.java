 ...
 * <p>
 * Ein Graben kann nach der Erzeugung nicht mehr veraendert werden. Die Reihenfolge, in der die beiden Positionen beim Erzeugen an den Konstruktor
 * uebergeben werden hat keine Auswirkung darauf, welche der beiden Positionen bei einem Aufruf von {@link #getFirst()}
 * bzw. {@link #getSecond()} zurueckgeliefert wird. Intern werden die Positionen umsortiert, damit zwei Graeben mit identischen
 ...
 * <p>
 * Die Methode {@link #parseDitch(String)} kann einen {@link String} in ein Ditch-Objekt umwandeln, wenn das Format gueltig ist.
 * </p>
 * <p>
 * Die Funktion {@link #hashCode()} liefert fuer alle gueltigen Graeben einen eindeutigen Hash-Wert zurueck. Spezielle Datenstrukturen
 * wie zum Beispiel ein {@link HashSet} koennen sich das zu Nutze machen. Ein Graben ist weiterhin mit anderen Graeben
...
public class Ditch implements Serializable, Comparable<Ditch> {
     ...
     * Beim Erzeugen werden die Positionen automatisch umsortiert.
     *
    ...
    /**
     * Wandle einen uebergebenen {@link String} in einen Graben um. Das Format ist: {@code {(Pos1.column,Pos1.row),(Pos2.column,Pos2.row)}}
     *
