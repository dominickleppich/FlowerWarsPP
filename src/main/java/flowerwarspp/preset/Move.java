 ...
 * <p>
 * Der Zug besteht aus zwei Blumen und wird ueber den Konstruktor {@link #Move(Flower, Flower)} erzeugt. Der Typ des Zuges wird
 * dabei automatisch auf {@link MoveType#Flower} gesetzt.
 * </p>
 ...
 * {@link MoveType#Surrender} oder {@link MoveType#End} erzeugt. Es ist nicht moeglich Blumen- oder Grabenzuege mit diesem
 * Konstruktor zu erzeugen!
 * </p>
 * <h2>Wichtige Hinweise</h2>
 * <p>
 * Ein Zug kann nach der Erzeugung nicht mehr veraendert werden. Die Reihenfolge, in der die Blumen beim Erzeugen an den Konstruktor
 * uebergeben werden hat keine Auswirkung darauf, welche der beiden Blumen bei einem Aufruf von {@link #getFirstFlower()} bzw.
 * {@link #getSecondFlower()} zurueckgeliefert wird. Intern werden die Blumen umsortiert, damit zwei Zuege mit identischen
 * Blumen, die jedoch mit vertauschter Reihenfolge der Blumen erzeugt wurden, dennoch einfach vergleichbar sind.
 * </p>
 * <h2>Zusatzfunktionalitaet</h2>
 * <p>
 * Die Methode {@link #parseMove(String)} kann einen {@link String} in ein Move-Objekt umwandeln, wenn das Format gueltig ist.
 * </p>
 * <p>
 * Die Funktion {@link #hashCode()} liefert fuer alle gueltigen Zuege einen eindeutigen Hash-Wert zurueck. Spezielle Datenstrukturen
 * wie zum Beispiel ein {@link HashSet} koennen sich das zu Nutze machen. Ein Zug ist weiterhin mit anderen Zuegen
...
public class Move implements Serializable, Comparable<Move> {
    ...
    /**
     * Erzeuge einen neuen Aufgabe- oder Spielende-Zug unter Angabe des Typs. Es ist nur moeglich Zuege vom Typen {@link MoveType#Surrender} und
     * {@link MoveType#End} auf diese Weise zu erzeugen.
     *
     * @param type Zugtyp
     * @throws IllegalArgumentException falls versucht wird mit diesem Konstruktor einen Zug vom Typen {@link MoveType#Flower} oder {@link MoveType#Ditch} zu erzeugen
     */
     ...
     * Beim Erzeugen werden die Blumen automatisch umsortiert.
     *
     * @param first  erste zu pflanzende Blume
     * @param second zweite zu pflanzende Blume
     * @throws IllegalArgumentException falls eine der Blumen {@code null} ist
     */
     ...
     *
     * @param ditch zu bauender Graben
     */
     ...
     *
     * @return erste Blume
     * @throws IllegalStateException falls es sich nicht um einen Blumenzug handelt
     */
     ...
     *
     * @param first erste Blume
     * @throws IllegalArgumentException falls die Blume {@code null} ist
     */
     ...
     *
     * @return Graben
     * @throws IllegalStateException falls es sich nicht um einen Grabenzug handelt
     */
     ...
     * @throws DitchFormatException falls kein gueltiger String uebergeben wird oder das Format ungueltig ist
     */
