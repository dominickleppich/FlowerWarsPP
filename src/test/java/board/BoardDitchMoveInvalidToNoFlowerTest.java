...
public class BoardDitchMoveInvalidToNoFlowerTest {
    ...
    public BoardDitchMoveInvalidToNoFlowerTest(Ditch ditch, Status expected) {
        this.ditch = ditch;
    ...
    public void testBridgeMove() {
        ...
        assertEquals("Invalid ditch to no land  " + ditch.toString(), expectedStatus, viewer
                .getStatus());
    }
