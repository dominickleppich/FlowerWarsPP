...
public class BoardFlowerMoveInvalidFusionFlowerBedsWithTwoFlowersToOversizedGardenTest {
    ...
    public void init() {
        ...
        replayMoves.add(new Move(new Flower(new Position(4, 3), new Position(5, 3), new Position(4, 4)),
                new Flower(new Position(5, 3), new Position(4, 4), new Position(5, 4))));
        ...
        replayMoves.add(new Move(new Flower(new Position(8, 3), new Position(7, 4), new Position(8, 4)),
                new Flower(new Position(2, 11), new Position(3, 11), new Position(2, 12))));
        replayMoves.add(new Move(new Flower(new Position(6, 5), new Position(7, 5), new Position(6, 6)),
        ...
        return Arrays.asList(new Object[][]{
                {
                        ...
                        new Move(new Flower(new Position(9, 2), new Position(8, 3), new Position(9, 3)),
                                new Flower(new Position(8, 3), new Position(9, 3), new Position(8, 4))), Status.Illegal
                }, {
                        new Move(new Flower(new Position(4, 6), new Position(3, 7), new Position(4, 7)),
                                new Flower(new Position(3, 7), new Position(4, 7), new Position(3, 8))), Status.Illegal
                }
        });
    }
