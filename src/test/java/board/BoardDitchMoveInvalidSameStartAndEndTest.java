...
public class BoardDitchMoveInvalidSameStartAndEndTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                // Invalid ditch (start == end)
                {new Ditch(new Position(5, 5), new Position(5, 5)), Status.Illegal},
                {new Ditch(new Position(6, 5), new Position(6, 5)), Status.Illegal},
                {new Ditch(new Position(5, 6), new Position(5, 6)), Status.Illegal}
        });
    }
    ...
    public void testBridgeMove() {
        ...
        assertEquals("Invalid ditch with same start and end " + ditch.toString(), expectedStatus, viewer.getStatus());
    }
}
